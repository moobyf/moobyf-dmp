...
\reportauthors{
$for(by-author)$
{$it.name.literal$$if(it.orcid)${\footnotesize~\orcidlink{$it.orcid$}}$endif$$if(it.email)$\href{mailto:$it.email$}{~\footnotesize\textcolor{moobyf-secondary}{\faIcon{envelope}}}$endif$}\\%
