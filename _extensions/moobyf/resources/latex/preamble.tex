...
\definecolor{moobyf-secondary}{RGB}{46, 76, 137} % $moobyf-secondary: rgb(36, 114, 181);
\definecolor{moobyf-ternary}{RGB}{59, 99, 178} %$moobyf-ternary: rgb(32,54,97);
\definecolor{moobyf-quartenary}{RGB}{91, 127, 200} %$moobyf-ternary: rgb(32,54,97);
...
\titleformat
	...
	{10pt} % Horizontal space between the section label and title
...
\titleformat
	...
	[block] % Section layout type, can be: hang, block, display, runin, leftmargin, rightmargin, drop, wrap, frame
	{\raggedright\itshape\normalsize\color{moobyf-quartenary}} % Text formatting of the whole section, i.e. label and title
...
\captionsetup{skip=8pt} % Vertical whitespace between figures/tables and the caption (default is 10pt)
