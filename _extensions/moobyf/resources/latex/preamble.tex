...
\graphicspath{{_extensions/ob7/resources/assets/}{./}{images/}} % Specifies where to look for included images (trailing slash required)
...
\definecolor{farquhar-body}{RGB}{19,21,22} % $farquhar-body: rgb(19, 21, 22);
\definecolor{farquhar-primary}{RGB}{3,41,95} %$farquhar-primary: rgb(3, 41, 95);
\definecolor{farquhar-secondary}{RGB}{36,114,181} % $farquhar-secondary: rgb(36, 114, 181);
% \definecolor{farquharfont}{RGB}{54,54,54}
\definecolor{farquhar-important}{RGB}{226,6,19} %$farquhar-important: rgb(226, 6, 19);
\definecolor{farquhar-bg}{RGB}{0,71,107}

\usepackage{hyperref}
\usepackage{mwe}
\hypersetup{
urlcolor=farquhar-primary
,linkcolor=.
,colorlinks=true}
...
\ofoot{\includegraphics[height=1.5cm]{ob7-logo.png}}
