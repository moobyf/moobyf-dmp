...
We need to define an ID for sites in purpose to keep on track our data and the sample. I propose something based on MT + CC + TS.
...
updated by the DMB prioritising FAIR principles. 
