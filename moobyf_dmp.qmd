...
1. Marine Instruments M3i+ buoys.
  ...
  - The data are stored in CSV file as numeric. They will read and process through a dedicated R script to determine the presence/absence of tuna.

2. Simrad WBAT echosounder.
  - A dedicated protocol for buoy deployment and data download is in preparation. The downloading needs to use the Matecho and Movies3D software (under Matlab environment), version Matecho20240821V7 and Movies3D2.2.16
...
where SX is the sample number (e.g. a recording depth for a hydrophone deployment or a camera identifier).
